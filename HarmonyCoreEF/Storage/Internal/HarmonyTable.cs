...
namespace Harmony.Core.EF.Storage.Internal
{
    ...
    /// </summary>
    public class HarmonyTable<TKey> : IHarmonyTable
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public HarmonyTable(IPrincipalKeyValueFactory<TKey> keyValueFactory, bool sensitiveLoggingEnabled)
        {
        ...
        public virtual void Delete(IUpdateEntry entry)
        {
            ...
            {
                throw new DbUpdateConcurrencyException(HarmonyStrings.UpdateConcurrencyException, new[] { entry });
            }
        }
        ...
        protected virtual void ThrowUpdateConcurrencyException(IUpdateEntry entry, Dictionary<IProperty, object> concurrencyConflicts)
        {
            if (_sensitiveLoggingEnabled)
            {
                throw new DbUpdateConcurrencyException(
                    HarmonyStrings.UpdateConcurrencyTokenExceptionSensitive(
            ...
            throw new DbUpdateConcurrencyException(
                HarmonyStrings.UpdateConcurrencyTokenException(
                    entry.EntityType.DisplayName(),
