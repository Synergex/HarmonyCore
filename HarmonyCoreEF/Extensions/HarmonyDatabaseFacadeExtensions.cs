...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class HarmonyDatabaseFacadeExtensions
    {
        /// <summary>
        ///     <para>
        ...
        public static bool IsHarmony(this DatabaseFacade database)
            => database.ProviderName.Equals(
                typeof(HarmonyOptionsExtension).GetTypeInfo().Assembly.GetName().Name,
