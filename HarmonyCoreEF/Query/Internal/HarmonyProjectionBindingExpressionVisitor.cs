...
{
    public class HarmonyProjectionBindingExpressionVisitor : ExpressionVisitor
    {
        private readonly HarmonyQueryableMethodTranslatingExpressionVisitor _queryableMethodTranslatingExpressionVisitor;
        private readonly HarmonyExpressionTranslatingExpressionVisitor _expressionTranslatingExpressionVisitor;
        ...
        public HarmonyProjectionBindingExpressionVisitor(
        ...
        protected override Expression VisitExtension(Expression extensionExpression)
        {
            if (extensionExpression is EntityShaperExpression entityShaperExpression)
            {
                ...
                return entityShaperExpression.Update(
                    new ProjectionBindingExpression(_queryExpression, _projectionMembers.Peek(), typeof(DataObjectBase)));
            }
