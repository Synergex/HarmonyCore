...
namespace Harmony.Core.EF.Query.Internal
{
    ...
    {
        private sealed class HarmonyProjectionBindingRemovingExpressionVisitor : ExpressionVisitor
        {
            ...
            protected override Expression VisitBinary(BinaryExpression binaryExpression)
            {
                    ...
                    && parameterExpression.Type == typeof(MaterializationContext))
                {
                    ...
                    var queryExpression = (HarmonyQueryExpression)projectionBindingExpression.QueryExpression;
                    ...
                    _materializationContextBindings[parameterExpression]
                        = ((IDictionary<IProperty, int>)GetProjectionIndex(queryExpression, projectionBindingExpression),
                            ((HarmonyQueryExpression)projectionBindingExpression.QueryExpression).CurrentParameter);

                    var updatedExpression = newExpression.Arguments[1];
