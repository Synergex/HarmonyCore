//Tristate extension with base implementation from https://github.com/gui-cs/Terminal.Gui/blob/develop/Terminal.Gui/Views/Checkbox.cs
...
namespace Terminal.Gui
{
	...
	/// </summary>
	public class TriStateCheckBox : View
	{
		Rune charChecked;
		Rune charUnChecked;
		Rune charIndeterminate;
		bool? @checked;
		...
		/// </summary>
		public TriStateCheckBox() : this(string.Empty) { }
		...
		public TriStateCheckBox(ustring s, bool? is_checked = false) : base()
		{
		...
		/// </remarks>
		public TriStateCheckBox(int x, int y, ustring s) : this(x, y, s, false)
		{
		}
		...
		///   text length. 
		/// </remarks>
		public TriStateCheckBox(int x, int y, ustring s, bool? is_checked) : base(new Rect(x, y, s.Length, 1))
		{
			Initialize(s, is_checked);
		}
		...
		void Initialize(ustring s, bool? is_checked)
		{
			...
			charIndeterminate = new Rune(Driver != null ? Driver.Diamond : 'O');
			Checked = is_checked;
		...
		protected override void UpdateTextFormatterText()
		{
			Rune currentRune;
			if (Checked.HasValue)
				currentRune = Checked.Value ? charChecked : charUnChecked;
			else
				currentRune = charIndeterminate;
			...
			switch (TextAlignment)
			{
				...
				case TextAlignment.Justified:
					TextFormatter.Text = ustring.Make(currentRune) + " " + GetFormatterText();
					break;
				case TextAlignment.Right:
					TextFormatter.Text = GetFormatterText() + " " + ustring.Make(currentRune);
					break;
			}
		}
