    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            LatestNugetReferences = new Dictionary<string, string>(StringComparer.CurrentCultureIgnoreCase)
            {
                ...
                {"Microsoft.AspNetCore.Mvc.NewtonsoftJson", "3.1.26"},
                {"Microsoft.AspNetCore.Mvc.Testing", "3.1.26"},
                {"Microsoft.Extensions.DependencyInjection", "3.1.6"},
                {"Microsoft.Extensions.Logging.Console", "3.1.26"},
                {"Microsoft.AspNetCore.SignalR.Client", "3.1.26"},
                {"Microsoft.EntityFrameworkCore", "3.1.26"},
                {"IdentityServer4.AccessTokenValidation", "3.0.1"},
                {"Microsoft.AspNetCore.OData", "7.4.1"},
                {"Microsoft.OData.Core", "7.7.0"},
                {"Microsoft.AspNetCore.JsonPatch", "3.1.26"},
